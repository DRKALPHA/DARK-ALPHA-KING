...
global.website = 'https://github.com/prabathLK/PRABATH-MD' //wa.me/+94713824099
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'DAK-MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94713824099',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY DAK-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'KAVINDU',
